...
from AlliceMusic.misc import SUDOERS
from AlliceMusic.utils.database import add_sudo, remove_sudo
from AlliceMusic.utils.decorators.language import language
from AlliceMusic.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_photo(photo="https://files.catbox.moe/x0a7zy.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("𝐒ᴜᴅᴏ 𝐋ɪsᴛ 𝐃ᴇᴋʜɴᴀ 𝐇ᴀɪ 𝐌ᴇʀᴇ 𝐁ᴇᴛᴇ Kᴏ 🤣 🤧🖕", show_alert=True)
    else:
